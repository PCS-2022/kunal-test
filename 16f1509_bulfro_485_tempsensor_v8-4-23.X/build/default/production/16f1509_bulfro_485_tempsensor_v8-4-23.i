# 1 "16f1509_bulfro_485_tempsensor_v8-4-23.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 288 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "16f1509_bulfro_485_tempsensor_v8-4-23.c" 2
# 12 "16f1509_bulfro_485_tempsensor_v8-4-23.c"
...
# 31 "16f1509_bulfro_485_tempsensor_v8-4-23.c" 2
# 41 "16f1509_bulfro_485_tempsensor_v8-4-23.c"
...
# 41 "16f1509_bulfro_485_tempsensor_v8-4-23.c" 2
...
# 42 "16f1509_bulfro_485_tempsensor_v8-4-23.c" 2
...
# 44 "16f1509_bulfro_485_tempsensor_v8-4-23.c" 2
# 61 "16f1509_bulfro_485_tempsensor_v8-4-23.c"
union {
...
unsigned char i2c_add, chk, lastadd, laststat, rxcnt, recvcnt, addval, ipval, data2sendcnt, i2cdelaycnt,datavalidval;
...
unsigned long int wdtcnt,longactval;
...
unsigned char tx2str[] = {0xff, 0x02, 0x04, 0x05};
...
void main() {
    ...
    txmul_fn(tx1str, 6);
    while (1) {
# 588 "16f1509_bulfro_485_tempsensor_v8-4-23.c"
        if (cond.tim_int_ind == 1) {
            ...
            txmul_fn(tx1str, 6);
            memset(tx1str,0,sizeof(tx1str));
# 619 "16f1509_bulfro_485_tempsensor_v8-4-23.c"
        }
