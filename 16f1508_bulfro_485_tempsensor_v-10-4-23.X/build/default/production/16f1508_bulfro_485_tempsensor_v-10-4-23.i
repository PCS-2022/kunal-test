# 1 "16f1508_bulfro_485_tempsensor_v-10-4-23.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 288 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "16f1508_bulfro_485_tempsensor_v-10-4-23.c" 2
# 12 "16f1508_bulfro_485_tempsensor_v-10-4-23.c"
...
# 31 "16f1508_bulfro_485_tempsensor_v-10-4-23.c" 2
# 41 "16f1508_bulfro_485_tempsensor_v-10-4-23.c"
...
# 41 "16f1508_bulfro_485_tempsensor_v-10-4-23.c" 2
...
# 42 "16f1508_bulfro_485_tempsensor_v-10-4-23.c" 2
...
# 44 "16f1508_bulfro_485_tempsensor_v-10-4-23.c" 2
# 61 "16f1508_bulfro_485_tempsensor_v-10-4-23.c"
union {
...
# 160 "16f1508_bulfro_485_tempsensor_v-10-4-23.c"
void I2CInit(void) {
    TRISB4 = 1;
    TRISB6 = 1;
    SSP1STAT |= 0x80;
...
void main() {
    ...
    adchval=1;
    while (1) {
# 583 "16f1508_bulfro_485_tempsensor_v-10-4-23.c"
    ...
    else
    {
        cond.togg=~cond.togg;
            ...
            txmul_fn(tx1str, 6);
            memset(tx1str,0,sizeof(tx1str));
# 632 "16f1508_bulfro_485_tempsensor_v-10-4-23.c"
        }
